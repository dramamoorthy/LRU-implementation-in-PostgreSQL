...
typedef struct sbufdesc
{
    ...
    int         free_previous; // the other variable needed for the LRU to show the previous node in linked list is added here and initialised in init.
...
#define FREE_PREVIOUS_NOT_IN_LIST (-3)
